    ...
    when (screen) {
        is Screen.Welcome -> {
            WelcomeScreen {
                ...
                onStartGame = { customMap, playerName, playerColor, carsCount, calculateScoresInProcess ->
                    customMap?.let { appState.initMap(it) }
                    startGame(playerName, playerColor, carsCount, calculateScoresInProcess, appState, str)
                }
