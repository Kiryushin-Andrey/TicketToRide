...
import org.w3c.xhr.*
import google.maps.*
import google.maps.StylingFunction
...
external open class Map<E : Element>(mapDiv: Element?, opts: MapOptions = definedExternally) : MVCObject {
    open fun <N : Any> addListener(eventName: N, handler: MVCEventHandler<Map<E> /* this */, Any>): MapsEventListener
    override fun addListener(eventName: String, handler: MVCEventHandler<MVCObject /* this */, Array<Any>>): MapsEventListener
...
external open class Data(options: Data.DataOptions = definedExternally) : MVCObject {
    ...
    open fun setDrawingMode(drawingMode: String)
...
external open class Marker(opts: ReadonlyMarkerOptions = definedExternally) : MVCObject {
    ...
    open fun getIcon(): dynamic /* String | ReadonlyIcon | ReadonlySymbol | Nothing? | Nothing? */
    open fun getLabel(): ReadonlyMarkerLabel?
    open fun getMap(): dynamic /* Map<Element> | StreetViewPanorama | Nothing? | Nothing? */
    ...
    open fun setPosition(latlng: Nothing?)
    ...
    open fun addListener(eventName: String, handler: (self: Marker) -> Unit): MapsEventListener
    open fun addListener(eventName: String, handler: (self: Marker, event: MouseEvent) -> Unit): MapsEventListener
